...
gamma = False							# If gamma point analysis, used to 
										# determine whether to share memory for
										# nmd post processing
...
gulpExe = 'gulp'					# Gulp Executable Name
...
avgName = 'nmd.avg.py'					# SpecED Avg Template Name

avgSubName = lammpsSubName				# SpecED Avg Submission Template Name
avgSubRunName = 'tmp.avg.sub'			# SpecED Avg Submission Run Name
...
tTotal = 2**16							# Total Run Time
tFft = 2**16							# Time for each FFT Block (Sets longest freq)
...
avgWallTime = 1							# SpecED Avg Processing Run Time
avgCpu = 1								# SpecED Avg Number of CPUs
...
numTstep = tFft / wStep / 100					# Number of FFT Time Steps
